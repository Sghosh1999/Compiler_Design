...
void identifier_find(char str[1000], int k, int start)
{
...
void literal_find(char str[1000], int k)
{
	for (int i = 0; i < k; i++)
	{
		char p[100];
...
void operator_find(char str[1000], int k, int start)
{
	for (int i = start; i < k; i++)
	{
...
void delimiter_find(char str[1000], int k)
{
	for (int i = 0; i < k; i++)
	{
...
int main()
{
	...
	printf("operators:\n");
	operator_find(literal_string, k, 17);
	printf("delimiters:\n");
	delimiter_find(literal_string, k);
	printf("identifiers:\n");
	identifier_find(literal_string, k, 17);
	printf("literal:\n");
	literal_find(literal_string, k);
}
